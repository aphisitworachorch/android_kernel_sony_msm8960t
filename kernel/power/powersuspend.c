...
static int state;
/* Yank555.lu : Current powersave suspend_mode  (kernel / panel) */
int suspend_mode = 1;
...
static struct kobj_attribute power_suspend_mode_attribute =
	__ATTR(power_suspend_mode, 0666,
		...
		NULL); // virgola a capo mode_store
...
/*
	suspend_mode = POWER_SUSPEND_AUTOSLEEP;
*/
	suspend_mode = POWER_SUSPEND_PANEL;
